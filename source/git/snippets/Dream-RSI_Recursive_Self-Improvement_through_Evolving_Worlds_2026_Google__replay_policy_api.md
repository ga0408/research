# Dream-RSI: Replay Policy API & Controller Specification

> 분석 문서: [Dream-RSI](../../../report/[paper][git]_Dream-RSI_Recursive_Self-Improvement_through_Evolving_Worlds_2026_Google.md)
> 원본: [arXiv:2609.14858](https://arxiv.org/abs/2609.14858) Appendix B.2

Dream-RSI에서 탐색 정책(Exploration Policy)을 오프라인 Replay 시뮬레이터 상에서 반복 평가하고 자체 개선할 때 사용하는 Python API 명세 및 제약 조건이다. 정책은 반드시 접두부 관측 정보(prefix-only)만을 기반으로 실행 결정을 내려야 한다.
