# Dream-RSI: Online Exploration Orchestration Prompt

> 분석 문서: [Dream-RSI](../../../report/[paper][git]_Dream-RSI_Recursive_Self-Improvement_through_Evolving_Worlds_2026_Google.md)
> 원본: [arXiv:2609.14858](https://arxiv.org/abs/2609.14858) Appendix B.1

온라인 탐색 단계에서 코딩 에이전트(Discovery Agent)에게 주입되는 오케스트레이션 프롬프트.
단순 무작위 탐색이나 국소 최적해(Local Optimum) 수렴을 방지하고, 전체 과거 이력의 원인 분석 및 구조적 다양성 확보를 강제한다.
