...
==================================================================================================
 [현재 질문 q=100] ── (각도 차이 δ = 100 - 0 = 100) ────► [과거 메모리 t=0] ──► ❌ 읽기 실패! (OOD 범위 초과!)
                                                                      (메모리가 저장되어 있어도 
...
### Q: 본 기법은 루프/재방문(LoopBench) 상황에서만 작동하는가?
**답변: 아닙니다! 논문은 (1) 일반 일방향 장기 생성과 (2) 루프 재방문 평가를 명확히 나누어 실험했습니다.**
...
+--------------------------------------------------------------------------------------------------+
  ...
  - 조건: 재방문/루프 없는 일방향 탐색 ($N=48$ Chunks)              - 조건: $A \to B \to A$, $A \to B \to C \to A$ 등
  - 적용: WorldTrace-Field                                         - 적용: WorldTrace-Landmark & LoopBench
  - 성과: TempSSIM +15.5% 향상 & Drift 최소화                      - 성과: PAC +19.5% 에피소드 회상 향상
```
